...
export const getLowStock=({search='',page=1,pageSize=20}={})=>authenticatedServiceRequest(base,`/api/inventory/items/low-stock?search=${encodeURIComponent(search)}&page=${page}&pageSize=${pageSize}`)

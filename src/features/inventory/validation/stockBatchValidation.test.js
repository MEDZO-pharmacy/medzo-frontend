...
const valid = { medicineId: 'medicine-1', batchNumber: 'LOT-001', description: 'Supplier invoice 10', sourceReference: 'INV-10', expiryDate: '2099-01-01', quantity: '10' }
describe('stock batch validation', () => {
  ...
  it('rejects a source reference beyond the API limit', () => expect(validateStockBatch({ ...valid, sourceReference: 'x'.repeat(151) })).toMatchObject({ sourceReference: expect.any(String) }))
})
